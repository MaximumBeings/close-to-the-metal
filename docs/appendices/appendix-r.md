# Appendix R — Edge Inference on Linux SBCs: Raspberry Pi and NVIDIA Jetson
...
### R.1.1 The Unified Memory Advantage — Shared by All SBCs

One property that all SBCs in this appendix share — and that they share with Apple Silicon (Appendix Q) — is **unified memory**: the CPU and GPU (where present) access the same physical RAM pool. There is no separate VRAM, no PCIe bus to transfer weights from system RAM to GPU memory.
...
## R.2 Part One: Raspberry Pi

### R.2.1 Choosing the Right Pi Model
...
### R.2.2 Operating System — Why 64-Bit Matters
...
### R.2.3 Swap Space — Why It Matters and How to Set It Up
...
### R.2.6 Model Storage — Why SD Cards Are Not Enough
...
### R.2.7 Quantization Tiers for Raspberry Pi
...
### R.2.8 Thermal Management — The Pi 5 Throttling Problem
...
### R.2.9 Running llama-server as a systemd Service
...
### R.2.10 Realistic Performance Expectations
...
It is **not enough** for multi-user interactive serving, real-time transcription, or any application requiring sub-second time-to-first-token on long prompts. For those requirements, move to the Jetson platform (R.3) or a data-center GPU.
...
## R.3 Part Two: NVIDIA Jetson

### R.3.1 Understanding the Jetson Product Line
...
### R.3.3 Building llama.cpp with CUDA on Jetson
...
### R.3.4 Power Mode Configuration — Unlocking Full Performance
...
### R.3.5 GPU Layer Offloading on Jetson
...
### R.3.6 Memory Budget and Quantization for Jetson
...
### R.3.7 Flash Attention on Jetson Orin
...
### R.3.8 Monitoring with tegrastats and jtop
...
### R.3.9 Thermal Management on Jetson
...
### R.3.10 Production Server Configuration for Jetson
...
### R.3.11 TensorRT-LLM on Jetson AGX Orin
...
## R.4 Platform Comparison — Pi vs Jetson
...
## R.5 Choosing the Right Platform
...
## R.6 Common Failure Modes and Fixes
