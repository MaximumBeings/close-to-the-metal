...
## U.2 The Quantization Parameter Decision Tree
...
### U.3.4 AWQ calibration timeline
...
### U.4.1 Running GPTQ calibration with `AutoGPTQ`
...
## U.5 FP8 Calibration with `llm-compressor`
...
### U.5.1 What FP8 calibration measures
...
## U.6 GGUF Quantization for llama.cpp
...
### U.6.2 Importance matrix quantization (IQ)
...
### U.6.3 Preparing calibration text for IQ
...
### U.7.2 Task-specific evaluation with `lm-evaluation-harness`
...
### U.7.3 Quantization quality thresholds
...
## U.8 Worked Example U.1 — End-to-End FP8 Calibration
...
```python
# [calibration script from §U.5.2, with your dataset]
```
...
## U.8.6 Calibration Data Bias Detection
...
## U.8.7 Quantization and LoRA Interaction
