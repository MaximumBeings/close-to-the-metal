# Appendix X: References and Papers
...
## X.1 Foundational Transformer Architecture
...
## X.2a Attention Variants and Architectural Alternatives
...
## X.3 KV Cache and Memory Management
...
## X.6 Distributed and Disaggregated Serving
...
## X.10 Systems and Infrastructure
...
*The authoritative CUDA reference. Appendix L.*
...
## X.11 Benchmarking and Evaluation
...
## X.13 Citation Index by Chapter
...
| Appendix L (CUDA) | NVIDIA CUDA Guide, Williams 2009 (Roofline) |
