...
<div class="book-cover-row">
  ...
  <div class="book-blurb">
    ...
    <p class="book-desc">A systems-engineering textbook for engineers who serve LLMs in production. Every concept is taught through two real engines simultaneously — <strong>vLLM</strong> and <strong>llama.cpp</strong> — with worked arithmetic, companion code, and production-grade configurations.</p>
  ...
  <div class="toc-parts">
    ...
    <div class="toc-part">
      <div class="toc-part-header toc-pa">
        ...
        <span class="toc-part-title">Appendices A – K</span>
